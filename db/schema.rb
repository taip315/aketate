...
ActiveRecord::Schema.define(version: 20_210_401_023_616) do
  ...
  create_table 'follow_requests', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[user_id shop_id], name: 'index_follow_requests_on_user_id_and_shop_id', unique: true
  ...
  create_table 'memberships', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[user_id shop_id], name: 'index_memberships_on_user_id_and_shop_id', unique: true
